...
export default function Statistics({
  ...
  return (
    <div className="h-12">
      <div className="m-0 font-normal text-3xl text-[#e2b714] font-roboto ">
        {!isTyping ? (
          finished ? (
            ...
            <div className="text-[#646669] bg-[#2c2e31] rounded-md flex text-base p-3 justify-center  items-center">
